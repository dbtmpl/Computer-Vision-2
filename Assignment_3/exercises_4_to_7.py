...
def main():
    ...
    do_4, do_6, do_7, do_ex_4_eval = False, False, True, False

    # Images for exercise 4
    if do_4 or do_ex_4_eval:
    ...
    if do_4:
        loss_data = exercise_4_and_5(model, optimizer, img, S_land, S_whole, face_model, triangles, number_whole_points)
    if do_6:
    ...
    if do_ex_4_eval:
        ...
        optimizer = torch.optim.Adam(model.parameters(), lr=0.1)
        loss_surprised = exercise_4_and_5(model, optimizer, img, S_land, S_whole, face_model, triangles,
                                          number_whole_points)
        ...
        ax.set_title("Loss for neutral and surprised face model", fontweight='bold', fontsize=18)
